...
export default function TermsAndConditions() {
  return (
    <div className="container mx-auto p-6 space-y-4">
      <h1 className="text-3xl w-full text-center font-bold mb-4">
      ...
      <section>
        ...
        <p>
          By accessing and using SmartAlgorhythm services, you agree to comply
          with these Terms and Conditions. These terms apply to all visitors,
      ...
      <section>
        ...
        <p>
          ...
          harassing or causing distress to any person, transmitting obscene or
          offensive content, or disrupting the normal flow of dialogue within
          our services.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          responsible for safeguarding your account, and you agree to notify us
          immediately of any unauthorized use. We are not liable for any losses
      ...
      <section>
        ...
        <p>
          ...
          limited to text, software, icons, logos, graphics, and hyperlinks, are
          the property of SmartAlgorhythm and are protected by law.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          SmartAlgorhythm shall not be liable for any indirect, incidental,
          special, or consequential damages, or loss of profits or revenue,
      ...
      <section>
        ...
        <p>
          ...
          with the laws of the jurisdiction in which SmartAlgorhythm operates,
          without regard to conflict of law principles.
        </p>
      </section>

      <p>
        For more information, please contact us at support@smartalgorhythm.com.
      </p>
    </div>
  );
}
